 ...
 */
final class Version20230301173153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE paste (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, url VARCHAR(255) NOT NULL, content CLOB NOT NULL, ttl VARCHAR(255) DEFAULT \'2 weeks\' NOT NULL --(DC2Type:dateinterval)
