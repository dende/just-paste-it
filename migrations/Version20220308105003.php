 ...
 */
final class Version20220308105003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE paste (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, url VARCHAR(255) NOT NULL, content CLOB NOT NULL, nonce VARCHAR(20) NOT NULL, public BOOLEAN NOT NULL)');
